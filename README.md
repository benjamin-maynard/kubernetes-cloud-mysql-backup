...
| BACKUP_TIMESTAMP                 | **(Optional)** Date string to prepend to the backup filename (golang `2006-01-02-15-04` format). Leave unset if using S3 Versioning and date stamp is not required.                                                     |
